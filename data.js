...
const TEAMS = {
  ...
  RSA: { name: "South Africa", flag: "🇿🇦", group: "A", elo: 1633, rank: 56, form: "WDWLL", star: "Lyle Foster",
  ...
  KOR: { name: "South Korea", flag: "🇰🇷", group: "A", elo: 1777, rank: 22, form: "WWWDW", star: "Son Heung-min",
  ...
  // ---- Group D ----
  USA: { name: "United States", flag: "🇺🇸", group: "D", elo: 1861, rank: 14, form: "WDWWL", star: "Christian Pulisic",
  ...
  TUR: { name: "Türkiye", flag: "🇹🇷", group: "D", elo: 1736, rank: 26, form: "WWWDW", star: "Arda Güler",
  ...
  // ---- Group E ----
  GER: { name: "Germany", flag: "🇩🇪", group: "E", elo: 1973, rank: 9, form: "WWWWW", star: "Jamal Musiala",
    note: "Nagelsmann's rebuild has clicked: ruthless qualifying finish, Musiala and Wirtz both fit, and Kimmich anchoring. Opened with a 7-1 demolition of Curaçao (Havertz brace), then ground out a 2-1 win over a stubborn Ivory Coast to seal a last-16 place with a game to spare. Still occasionally vulnerable to elite pace in behind. (Rating +13, then +15.)" },
  CUW: { name: "Curaçao", flag: "🇨🇼", group: "E", elo: 1566, rank: 80, form: "DWDWL", star: "Leandro Bacuna",
  ...
  ECU: { name: "Ecuador", flag: "🇪🇨", group: "E", elo: 1791, rank: 23, form: "DWDWL", star: "Moisés Caicedo",
  ...
  CIV: { name: "Ivory Coast", flag: "🇨🇮", group: "E", elo: 1755, rank: 40, form: "WDWLW", star: "Amad Diallo",
    note: "2024 AFCON winners with real wing talent (Amad, Adingra) and a powerful midfield. Stunned Ecuador 1-0 in their opener but then lost 2-1 to Germany, undone after taking the game to the favourites — Group E now hinges on their finale (rating +40, then -15)." },

  // ---- Group F ----
  NED: { name: "Netherlands", flag: "🇳🇱", group: "F", elo: 1970, rank: 7, form: "WWWDW", star: "Virgil van Dijk",
    note: "Koeman's side rolled through qualifying behind Van Dijk's top-five defence. June 2026 injuries bite, though: Xavi Simons (ACL) and Schouten are out for the tournament, Timber withdrew, keeper Verbruggen has a hip knock and Depay arrives carrying a hamstring. After a frustrating 2-2 opening draw vs Japan they roared to life with a 5-1 demolition of Sweden, the attack finally clicking (rating -6, then +41)." },
  JPN: { name: "Japan", flag: "🇯🇵", group: "F", elo: 1897, rank: 18, form: "WDWWW", star: "Takefusa Kubo",
  ...
  SWE: { name: "Sweden", flag: "🇸🇪", group: "F", elo: 1791, rank: 45, form: "WLLWWL", star: "Viktor Gyökeres",
  ...
  TUN: { name: "Tunisia", flag: "🇹🇳", group: "F", elo: 1632, rank: 41, form: "WWDWLL", star: "Hannibal Mejbri",
  ...
  // ---- Group G ----
  BEL: { name: "Belgium", flag: "🇧🇪", group: "G", elo: 1838, rank: 8, form: "DWWDD", star: "Jérémy Doku",
  ...
  EGY: { name: "Egypt", flag: "🇪🇬", group: "G", elo: 1781, rank: 32, form: "WWDWD", star: "Mohamed Salah",
  ...
  IRN: { name: "Iran", flag: "🇮🇷", group: "G", elo: 1754, rank: 20, form: "DWWLD", star: "Mehdi Taremi",
  ...
  NZL: { name: "New Zealand", flag: "🇳🇿", group: "G", elo: 1577, rank: 83, form: "WLDWD", star: "Chris Wood",
  ...
  // ---- Group H ----
  ESP: { name: "Spain", flag: "🇪🇸", group: "H", elo: 2136, rank: 1, form: "WWWWD", star: "Lamine Yamal",
    note: "World #1 by a distance, Euro 2024 champions with a generational midfield. After a stunning 0-0 opener against Cape Verde, they returned to their fluent best — Yamal pulling the strings in a 4-0 demolition of Saudi Arabia. Still comfortably the strongest team in the field (rating −28, then +7)." },
  CPV: { name: "Cape Verde", flag: "🇨🇻", group: "H", elo: 1632, rank: 68, form: "DWLWD", star: "Ryan Mendes",
  ...
  KSA: { name: "Saudi Arabia", flag: "🇸🇦", group: "H", elo: 1651, rank: 59, form: "DLWDD", star: "Salem Al-Dawsari",
  ...
  URU: { name: "Uruguay", flag: "🇺🇾", group: "H", elo: 1848, rank: 16, form: "DWLWD", star: "Federico Valverde",
  ...
  // ---- Group L ----
  ENG: { name: "England", flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", group: "L", elo: 2026, rank: 4, form: "WWWWW", star: "Jude Bellingham",
  ...
  CRO: { name: "Croatia", flag: "🇭🇷", group: "L", elo: 1860, rank: 10, form: "WWDWD", star: "Luka Modrić",
  ...
  GHA: { name: "Ghana", flag: "🇬🇭", group: "L", elo: 1704, rank: 73, form: "WLWDW", star: "Mohammed Kudus",
  ...
  PAN: { name: "Panama", flag: "🇵🇦", group: "L", elo: 1649, rank: 30, form: "WDWWD", star: "Adalberto Carrasquilla",
...
const MATCHES = [
  ...
  { d: "Jun 24", et: "21:00", g: "A", h: "RSA", a: "KOR", city: "Monterrey", result: [0, 1] },
